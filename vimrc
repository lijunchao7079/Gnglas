...
hi Function        ctermfg=134   guifg=#7D7777 gui=bold            cterm=bold
noremap H ^
noremap L $
...
let s:colors.base2 = { 'gui': '#091f2e', 'cterm': 236  }
...
" let s:colors.red     = { 'gui': '#c23127', 'cterm': 124 }
 let s:colors.red     = { 'gui': '#33859E', 'cterm': 44 }
let s:colors.orange  = { 'gui': '#ff0000', 'cterm': 196 }
...
let s:colors.blue    = { 'gui': '#888ca6', 'cterm':  104 }
